					...
					return function() {
						return applyTransform(element, originalPos, (function() {
							...
							_results = [];
								...
								_results.push([$( window ).width()/7.662650602409639, ($(window).width()*0.7201257862)/8.778676250819048]);//Left Top
								_results.push([$( window ).width()/6.838709677419355, ($(window).width()*0.7201257862)/1.2017744541538462]);//Left bottom
								_results.push([$( window ).width()/2.904109589041096, ($(window).width()*0.7201257862)/4.060621173286344]);//right top
								_results.push([$( window ).width()/2.904109589041096, ($(window).width()*0.7201257862)/1.7069648265481483]);//right bottom
							return _results;
						})(), callback);
					};
				})(this)
